      ...
      <main className='p-6 space-y-6'>
        ...
        <section className='grid grid-cols-1 md:grid-cols-3 gap-3'>
          ...
          <div className='rounded border p-4 bg-white'>
            ...
            <div
              className={`text-xl font-semibold ${balance >= 0 ? 'text-emerald-700' : 'text-red-700'}`}
            >
        ...
        <section className='rounded border p-4 bg-white space-y-3'>
          ...
          >
            ...
            <input
              ...
              value={newMv.concept}
              onChange={(e) =>
                setNewMv((s) => ({ ...s, concept: e.target.value }))
              }
              required
            />
            <input
              ...
              value={newMv.amount}
              onChange={(e) =>
                setNewMv((s) => ({ ...s, amount: Number(e.target.value) }))
              }
              required
            />
            <input
              ...
              value={newMv.date}
              onChange={(e) =>
                setNewMv((s) => ({ ...s, date: e.target.value }))
              }
              required
            />
            <button
